...
var getWorkList = function(req, res, next) {
    var data = {
...
var makeWork = function(req, res, next) {
    var data = {
        access_token : req.header('access-token'),
        team_id : req.params.team_id,
        section_id : req.params.section_id,
...
var editWorkInfo = function(req, res, next) {
    var data = {
        access_token : req.header('access-token'),
        team_id : req.params.team_id,
        section_id : req.params.section_id,
...
var getWorkInfo = function(req, res, next) {
    var data = {
        access_token : req.header('access-token'),
        team_id : req.params.team_id,
        section_id : req.params.section_id,
...
var joinWork = function(req, res, next) {
    var data = {
        access_token : req.header('access-token'),
        team_id: req.params.team_id,
        section_id : req.params.section_id,
...
module.exports.getWorkList = getWorkList;
module.exports.makeWork = makeWork;
module.exports.editWorkInfo = editWorkInfo;
module.exports.getWorkInfo = getWorkInfo;
module.exports.deleteWork = deleteWork;
module.exports.joinWork = joinWork;